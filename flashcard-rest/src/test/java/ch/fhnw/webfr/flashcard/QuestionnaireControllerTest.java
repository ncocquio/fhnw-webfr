...
public class QuestionnaireControllerTest {
    ...
    public void findAll_QuestionnairesFound_ShouldReturnFoundQuestionnaires() throws Exception {
		...
		when(questionnaireRepositoryMock.findAllByOrderByIdAsc()).thenReturn(Arrays.asList(questionnaire1, questionnaire2));
	    ...
	    Mockito.verify(questionnaireRepositoryMock, times(1)).findAllByOrderByIdAsc();
    }
	...
	public void update_questionnaire_ShouldReturnOK() throws Exception {
		...
		when(questionnaireRepositoryMock.findById("1")).thenReturn(qOptional);
